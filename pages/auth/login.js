...
export default function Login() {
  return (
    <div className="w-full min-h-screen flex flex-col justify-center px-5 py-20 bg-white space-y-5">
      <div className="hidden sm:absolute sm:inset-y-0 sm:block sm:h-full sm:w-full overflow-hidden" aria-hidden="true">
      ...
      <div className="text-gray-800 font-medium opacity-90 text-2xl mx-auto">Log in to unnamed-project</div>
      <button
